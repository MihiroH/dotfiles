...
TOOLS:
    zsh, git, nvim, karabiner, iterm, kitty, cmux, mise, claude, tmux
...
# Package definitions
BREW_PACKAGES=("git" "ripgrep" "gh" "ghq" "fd" "fzf" "nvim" "prettierd" "gpg" "mise" "lua" "tmux")
...
DEFAULT_TOOLS=("zsh" "git" "nvim" "cmux" "karabiner" "iterm" "claude" "tmux")
